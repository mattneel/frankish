...
// The registry check (M17, D-062): typed fn-pointer assertions
// generated by build.rs from frk-abi — a signature drifting from the
// registered ABI refuses to compile.
include!(concat!(env!("OUT_DIR"), "/abi_assertions.rs"));
